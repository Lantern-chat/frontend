...
// https://stackoverflow.com/a/13348618/2083075
function isChrome() {
    let isChromium = "chrome" in window,
        winNav = window.navigator,
        vendorName = winNav.vendor,
        isIOSChrome = winNav.userAgent.match("CriOS"); // iOS forces using their browser, not Blink

    return !isIOSChrome && isChromium && vendorName === "Google Inc.";
}
...
if(__DEV__) {
    ...
    IS_CHROME && console.log("USING CHROME");
}

// https://bugs.chromium.org/p/chromium/issues/detail?id=1213045
export const LAZY_ATTR = IS_CHROME ? undefined : "lazy";