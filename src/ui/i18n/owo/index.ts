...
const owo: Translation = {
    ...
    REGISTER: "wegistew",
    LOGIN: "wogin",
    EMAIL_ADDRESS: "emaiw addwess",
    USERNAME: "usewname",
    USERNAME_OR_EMAIL: "usewname ow emaiw",
    NICKNAME: "nickname",
    PASSWORD: "passwowd",
    RESET: "weset",
    DATE_OF_BIRTH: "date of biwth",
    NETWORK_ERROR: "netwowk ewwow",
    UNKNOWN_ERROR: "unknown e-ewwow",
    MFA_TOGGLE_TEXT: "{h|{true: don't h-have σωσ, false: h-have}} a 2fa code?",
    MFA_TOGGLE_FLAVOR: "cwick hewe to {h|{true: hide OwO, false: show}} the i-input.",
    MFA_CODE: "2fa code",
